...
<table class="table table-bordered w-80">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><img style="width:120px" src="../gambar/<?php echo $r['gambar'] ?>" alt=""></td>
            <td><a class="btn btn-primary" href="?f=menu&m=delete&id=<?php echo $r['idmenu'] ?>">Delete</a></td>
            <td><a class="btn btn-dark" href="?f=menu&m=update&id=<?php echo $r['idmenu'] ?>">update</a></td>
        </tr>
        <?php endforeach ?>
        <?php } ?>
    </tbody>
