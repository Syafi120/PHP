...
<table class="table table-bordered w-70 mt-4">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-info" href="?f=pelanggan&m=Delete&id=<?php echo $r['idpelanggan']?>">Delete</a></td>
            <td><a class="btn btn-dark"
                    href="?f=pelanggan&m=Update&id=<?php echo $r['idpelanggan']?>"><?php echo $status?></a>
            </td>
        </tr>
        <?php endforeach ?>
    </tbody>
