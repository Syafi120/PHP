...
<div class="card" style="width: 15rem; float:left; margin:10px;">
    <img style="height:250px;" src=" gambar/<?php echo $r['gambar'] ?>" class="card-img-top" alt="...">
    <div class="card-body">
        <h5 class="card-title"><?php echo $r['menu'] ?></h5>
        <p class="card-text"><?php echo $r['harga'] ?></p>
        <a class="btn btn-dark" href="?f=home&m=Checkout&id=<?php echo $r['idmenu']?>" role="button">Check Out Now!</a>
    </div>
</div>
<?php endforeach ?>
<?php } ?>
