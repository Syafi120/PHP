...
<br>
<hr>
<table class="table table-success table-striped w-70 mt-4 text-center">
    <thead>
        <tr>
            <th>No</th>
            <th>Order Date</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="?f=home&m=detail&id=<?php echo $r['idorder']?>" class="btn btn-secondary">Detail</a></td>
        </tr>
        <?php endforeach ?>
        <?php } ?>
    </tbody>
